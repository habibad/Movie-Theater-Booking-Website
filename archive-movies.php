                ...
                <a href="<?php echo get_permalink(); ?>">
                    ...
                    <div class="movie-overlay">
                        ...
                        <div class="movie-actions">
                            <button class="action-btn add-to-watchlist" title="Add to Watch List" data-movie-id="<?php echo $movie_id; ?>">
                                <svg width="20" height="20" fill="white" viewBox="0 0 24 24">
                                    <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
                                </svg>
                            </button>
                            <button class="action-btn share-movie" title="Share" data-movie-id="<?php echo $movie_id; ?>">
                                <svg width="20" height="20" fill="white" viewBox="0 0 24 24">
            ...
            <div class="no-movies">
                <div class="no-movies-content">
                    <svg width="80" height="80" fill="#ccc" viewBox="0 0 24 24">
                        <path d="M18 4V3c0-.55-.45-1-1-1H5c-.55 0-1 .45-1 1v4c0 .55.45 1 1 1s1-.45 1-1V5h10v10.5c0 .83-.67 1.5-1.5 1.5S13 16.33 13 15.5V10c0-.55-.45-1-1-1H7c-.55 0-1 .45-1 1v7c0 1.1.9 2 2 2h8c1.66 0 3-1.34 3-3V4z"/>
                    </svg>
                    <h3>No Movies Found</h3>
                    <p>We couldn't find any movies matching your criteria. Please try adjusting your filters or check back later.</p>
